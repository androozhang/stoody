dragElement(document.getElementById("quoteGenerator"));
dragElement(document.getElementById("quoteDiv"));
...
let getQuote = () => {
  fetch(url)
    ...
    .then((item) => {
      ...
      author.innerText = "- " + item.author; // Add the author under the quote
    });
};
